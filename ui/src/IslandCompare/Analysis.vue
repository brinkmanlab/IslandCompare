<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <b-container class="Analysis" fluid>
        <header><h4>2025-03-18 - This application is currently unavailable as it undergoes maintenance/assessment. Please contact us at islandpick-mail@sfu.ca if you have any urgent needs. Note that the file upload section on this page is 'Loading...' due to the IslandCompare back-end being shutdown during this assessment. We apologize for any inconvenience.</h4></header>
