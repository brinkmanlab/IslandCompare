                ...
                <b-tabs v-model="current_tab" class="analysis-tabs">
                    ...
                    <b-tab class="help" title="Instructions">
                        ...
                        <ol>
                            ...
                            <li><em>Upload a newick formatted tree (Optional)</em><p>The tree will decide the order of alignment in the visualization. The file must have a '.newick' extension and refer to the genomes by accession.</p></li>
